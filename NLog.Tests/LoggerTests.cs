	...
	public class LoggerTests : NLogTestBase
	{
		...
		public void TraceTest()
		{
			...
			for(int enabled = 0; enabled < 2; ++enabled)
			{
				...
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message1");

				logger.Trace(CultureInfo.InvariantCulture, "message{0}", (ulong)2);
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message2");
				...
				if(enabled == 1)
					AssertDebugLastMessage("debug", "messageobject-to-string");
				...
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message1,5");

				logger.Trace((double)1.5);
				if(enabled == 1)
					AssertDebugLastMessage("debug", "1,5");
				...
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message from lambda");
				
				logger.Trace((int arg1) => string.Format("message from func({0})", arg1), 5);
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message from func(5)");
		...
		public void DebugTest()
		{
			...
			for(int enabled = 0; enabled < 2; ++enabled)
			{
				...
				logger.Debug((int arg1) => string.Format("message from func({0})", arg1), 5);
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message from func(5)");
		...
		public void InfoTest()
		{
			...
			for(int enabled = 0; enabled < 2; ++enabled)
			{
				...
				logger.Info((int arg1) => string.Format("message from func({0})", arg1), 5);
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message from func(5)");
		...
		public void WarnTest()
		{
			...
			for(int enabled = 0; enabled < 2; ++enabled)
			{
				...
				logger.Warn((int arg1) => string.Format("message from func({0})", arg1), 5);
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message from func(5)");
		...
		public void ErrorTest()
		{
			...
			for(int enabled = 0; enabled < 2; ++enabled)
			{
				...
				logger.Error(delegate {
					return "message from lambda"; });
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message from lambda");
				
				logger.Error((int arg1) => string.Format("message from func({0})", arg1), 5);
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message from func(5)");
		...
		public void FatalTest()
		{
			...
			for(int enabled = 0; enabled < 2; ++enabled)
			{
				...
				logger.Fatal(delegate {
					return "message from lambda"; });
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message from lambda");
				
				logger.Fatal((int arg1) => string.Format("message from func({0})", arg1), 5);
				if(enabled == 1)
					AssertDebugLastMessage("debug", "message from func(5)");
		...
		public void LogTest()
		{
			...
			foreach(LogLevel level in new LogLevel[] { LogLevel.Debug, LogLevel.Info, LogLevel.Warn, LogLevel.Error, LogLevel.Fatal })
			{
				...
				<nlog>
					...
					logger.Log(level, delegate {
						return "message from lambda"; });
					if(enabled == 1)
						AssertDebugLastMessage("debug", "message from lambda");
					
					logger.Log(level, (int arg1) => string.Format("message from func({0})", arg1), 5);
					if(enabled == 1)
						AssertDebugLastMessage("debug", "message from func(5)");
